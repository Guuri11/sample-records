 ...
 */
final class Version20200409145905 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song DROP song_size, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL, CHANGE video_src video_src VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song ADD song_size INT NOT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL, CHANGE video_src video_src VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE ticket CHANGE event_id event_id INT DEFAULT NULL');
