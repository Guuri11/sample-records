 ...
 */
final class Version20200416155329 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase ADD comment_id INT DEFAULT NULL, CHANGE user_id user_id INT DEFAULT NULL, CHANGE time time TIME DEFAULT NULL, CHANGE town town VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase DROP comment_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE time time TIME DEFAULT \'NULL\', CHANGE town town VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE city city VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
