 ...
 */
final class Version20200409154515 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD profile_image VARCHAR(255) NOT NULL, ADD profile_size INT NOT NULL, ADD header_image VARCHAR(255) NOT NULL, ADD header_size INT NOT NULL, CHANGE roles roles JSON NOT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE postal_code postal_code INT DEFAULT NULL, CHANGE town town VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE credit_card credit_card VARCHAR(255) DEFAULT NULL');
