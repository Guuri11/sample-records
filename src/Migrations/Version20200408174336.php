 ...
 */
final class Version20200408174336 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE artist CHANGE name name VARCHAR(20) DEFAULT NULL, CHANGE surname surname VARCHAR(75) DEFAULT NULL, CHANGE is_from is_from VARCHAR(255) DEFAULT NULL, CHANGE bio bio VARCHAR(500) DEFAULT NULL');
