 ...
 */
final class Version20200418161215 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase DROP FOREIGN KEY FK_6117D13BF8697D13');
        $this->addSql('DROP INDEX UNIQ_6117D13BF8697D13 ON purchase');
        $this->addSql('ALTER TABLE purchase ADD comment VARCHAR(255) DEFAULT NULL, DROP comment_id, CHANGE user_id user_id INT DEFAULT NULL, CHANGE time time TIME DEFAULT NULL, CHANGE town town VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase ADD comment_id INT DEFAULT NULL, DROP comment, CHANGE user_id user_id INT DEFAULT NULL, CHANGE time time TIME DEFAULT \'NULL\', CHANGE town town VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE city city VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE purchase ADD CONSTRAINT FK_6117D13BF8697D13 FOREIGN KEY (comment_id) REFERENCES comment (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6117D13BF8697D13 ON purchase (comment_id)');
