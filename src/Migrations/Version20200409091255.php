 ...
 */
final class Version20200409091255 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE category_id category_id INT DEFAULT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT NULL, CHANGE size size VARCHAR(50) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE artist_id artist_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product DROP image_name, DROP image_size, CHANGE category_id category_id INT DEFAULT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT \'NULL\', CHANGE size size VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
