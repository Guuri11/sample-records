 ...
 */
final class Version20200409110450 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE album ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE artist_id artist_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE event ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE post ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE artist_id artist_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE song ADD song_file_name VARCHAR(255) NOT NULL, ADD song_size INT NOT NULL, ADD image_name VARCHAR(255) NOT NULL, ADD image_size INT NOT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL, CHANGE video_src video_src VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE album DROP image_name, DROP image_size, CHANGE artist_id artist_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id INT DEFAULT NULL, CHANGE event_id event_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE post_id post_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE event DROP image_name, DROP image_size, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE city city VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE post DROP image_name, DROP image_size, CHANGE artist_id artist_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE song DROP song_file_name, DROP song_size, DROP image_name, DROP image_size, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE album_id album_id INT DEFAULT NULL, CHANGE video_src video_src VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE ticket CHANGE event_id event_id INT DEFAULT NULL');
