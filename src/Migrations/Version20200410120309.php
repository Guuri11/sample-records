 ...
 */
final class Version20200410120309 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE description description VARCHAR(1200) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE post CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE description description VARCHAR(800) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
