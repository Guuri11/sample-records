 ...
 */
final class Version20200523214856 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_97A0ADA3D948EE2 ON ticket (serial_number)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_97A0ADA3D948EE2 ON ticket');
        $this->addSql('ALTER TABLE ticket CHANGE event_id event_id INT DEFAULT NULL');
