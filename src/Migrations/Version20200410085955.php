 ...
 */
final class Version20200410085955 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE album CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE duration duration INT NOT NULL');
