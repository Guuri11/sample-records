 ...
 */
final class Version20200517205838 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket ADD sold TINYINT(1) NOT NULL, CHANGE event_id event_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP sold, CHANGE event_id event_id INT DEFAULT NULL');
