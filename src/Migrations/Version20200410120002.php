 ...
 */
final class Version20200410120002 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE purchase CHANGE user_id user_id INT DEFAULT NULL, CHANGE time time TIME DEFAULT NULL, CHANGE town town VARCHAR(255) DEFAULT NULL, CHANGE city city VARCHAR(255) DEFAULT NULL, CHANGE comment comment VARCHAR(550) DEFAULT NULL');
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT NULL, CHANGE size size VARCHAR(50) DEFAULT NULL, CHANGE description description VARCHAR(800) NOT NULL');
        $this->addSql('ALTER TABLE post CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE description description VARCHAR(800) NOT NULL');
        $this->addSql('ALTER TABLE album CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE duration duration INT DEFAULT NULL');
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id INT DEFAULT NULL, CHANGE event_id event_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE post_id post_id INT DEFAULT NULL, CHANGE comment comment VARCHAR(500) NOT NULL');
        $this->addSql('ALTER TABLE artist CHANGE name name VARCHAR(20) DEFAULT NULL, CHANGE surname surname VARCHAR(75) DEFAULT NULL, CHANGE is_from is_from VARCHAR(255) DEFAULT NULL, CHANGE bio bio VARCHAR(750) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE comment CHANGE user_id user_id INT DEFAULT NULL, CHANGE event_id event_id INT DEFAULT NULL, CHANGE product_id product_id INT DEFAULT NULL, CHANGE post_id post_id INT DEFAULT NULL, CHANGE comment comment VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('ALTER TABLE post CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE product CHANGE category_id category_id INT DEFAULT NULL, CHANGE artist_id artist_id INT DEFAULT NULL, CHANGE discount discount DOUBLE PRECISION DEFAULT \'NULL\', CHANGE size size VARCHAR(50) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`, CHANGE description description VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`');
