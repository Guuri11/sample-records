...
class SongController extends AbstractController
{
     ...
     * @return Response
     */
    public function new(Request $request, CustomFileUploader $fileUploader): Response
    {
        $song = new Song();
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $songFileName = $fileUploader->upload($songFile,'%kernel.project_dir%/public/songs');
     ...
     * @return Response
     */
    public function edit(Request $request, Song $song, CustomFileUploader $fileUploader): Response
    {
        $form = $this->createForm(SongType::class, $song);
        $form->handleRequest($request);
