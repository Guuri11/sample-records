...
class Home extends Component{
    ...
    getLastProducts () {
        axios.get(`/api/v1.0/product?last=6`).then(res => {
            if (res.data.success === true){
                    ...
                    <div className="carousel-inner" role="listbox">
                        {
                            ...
                            {
                                const route = this.getImgSliderRoute(item);
                                return (
                                    <div key={i} className={i === 0 ? "carousel-item carousel-height active" : "carousel-item carousel-height" }>
                                        <img src={route+item.img_name} className="d-block img-fluid"/>
                                ...
                                return (
                                    <div key={i}>
                                        <div className="card card-post">
                                            <Link to={'/'}>
                                                <img src={"/img/posts/"+post.img_name} className="card-img-top" alt={post.name} height={200} width={100}/>
                                    ...
                                    <div key={i}>
                                        <div className="wrapper">
                                            <div className="container">
                                                <div className="top" >
                                                    <img src={"/img/products/"+product.img_name} className="product-img-top" alt={product.name} height={200} width={100}/>
                                                </div>
                                ...
                                <div className="row align-items-end pb-md-5">
                                    <div className="col-12 col-md-5 col-lg-4">
                                        <div className="featured-artist-thumb">
                                            <img src={"/img/songs/"+this.state.last_song[0].img_name} width={280} height={250} alt={this.state.last_song[0].title}/>
                                        </div>
                                    </div>
                                        ...
                                        <div className="featured-artist-content">
                                            ...
                                            <div className="song-play-area">
                                                <div className="song-name">
                                                    <p>{this.state.last_song[0].title}</p>
                                                </div>
