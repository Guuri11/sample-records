...
class Tickets extends Component {
                            ...
                            <div className="row">
                                ...
                                <div className="col-sm-12 col-md-3">
                                    <button className="btn btn-primary btn-success mt-3"
                                            onClick={() => this.setState({section:"new"}) }>Crear entrada</button>
                                </div>
                            </div>
    ...
    _renderNew = () => {
        ...
        return (
            <div className={"row"}>
                <div className="card s<selehadow mb-4 w-100">
                    <div className="card-header py-3">
                        <h5 className="m-0 font-weight-bold text-sr">Crear entrada</h5>
                        {
    ...
    handleCreate = (e) => {
        ...
        fetch('/api/v1.0/ticket/new', requestOptions)
            ...
            .then(data => {
                if (data.success){
                    let ticket = data.results;
                    // Get new ticket
                    ticket = data.results;
                    // Update product list
                    total_items.unshift(ticket);
